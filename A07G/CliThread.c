...
static SemaphoreHandle_t xReadSemaphore;
static cbuf_handle_t circularBuffer;
static uint8_t bufferData[BUFFER_SIZE];
...
static const CLI_Command_Definition_t xVersionCommand =
{
	...
	(const pdCOMMAND_LINE_CALLBACK)CLI_VersionCommand,
0};

static const CLI_Command_Definition_t xTicksCommand =
{
	"ticks",
	"ticks: Prints the number of ticks since scheduler started\r\n",
	(const pdCOMMAND_LINE_CALLBACK)CLI_TicksCommand,
0};
